...
var Grid = fc.Grid = RowRenderer.extend({
    ...
    /* Item-rendering and event-interaction methods for the abstract Grid class
----------------------------------------------------------------------------------------------------------------------*/
...
Grid.mixin({
	...
	// `range` can be the Item object itself, or something range-like, with at least a `start`.
...
// to be used for Item Object creation.
...
var DayGrid = Grid.extend({
    ...
    /* Item-rendering methods for the DayGrid class
----------------------------------------------------------------------------------------------------------------------*/
...
var TimeGrid = Grid.extend({
    ...
    /* Item-rendering methods for the TimeGrid class
----------------------------------------------------------------------------------------------------------------------*/
...
function EventManager(options) { // assumed to be a calendar
			...
			if (fetchID == currentFetchID) {
				...
				if (eventInputs) {
					for (i = 0; i < eventInputs.length; i++) {
						...
						if (isArraySource) { // array sources have already been convert to Item Objects
	...
	function buildEventSource(sourceInput) { // will return undefined if invalid source
		...
		if (source) {
			...
			// for array sources, we convert to standard Item Objects up front
	...
	function removeEvents(filter) {
		...
		// This works because they have been converted to official Item Objects up front.
	...
	// Given a raw object with key/value properties, returns an "abstract" Item object.
	...
	// Accepts an Item object, or a plain object with event-ish properties.
